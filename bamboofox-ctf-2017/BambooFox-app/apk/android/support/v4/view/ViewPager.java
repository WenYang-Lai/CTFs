...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03831());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03831 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03831() {
            }
