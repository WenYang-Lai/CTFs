...
public class Marker extends MapFeatureBaseWithFill implements MapMarker {
    ...
    private static final MapFeatureVisitor<Double> bearingComputation = new C04072();
    private static final MapFeatureVisitor<Double> distanceComputation = new C04061();
    ...
    static class C04061 implements MapFeatureVisitor<Double> {
        C04061() {
        }
    ...
    static class C04072 implements MapFeatureVisitor<Double> {
        C04072() {
        }
