...
public class NanoHTTPD {
    ...
    public NanoHTTPD(int port, File wwwroot) throws IOException {
        ...
        this.myThread = new Thread(new C03331());
                ...
                if (res != null) {
                    ...
                    try {
                        ...
                        if (range != null || startFrom < 0) {
                            ...
                            InputStream c03342 = new FileInputStream(f) {
                                public int available() throws IOException {
                                    return (int) dataLen;
                                }
                            };
                            c03342.skip(startFrom);
                            response2 = new Response(HTTP_PARTIALCONTENT, mime, c03342);
