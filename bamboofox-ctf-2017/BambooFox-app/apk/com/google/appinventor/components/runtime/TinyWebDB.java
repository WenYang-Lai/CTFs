...
public class TinyWebDB extends AndroidNonvisibleComponent implements Component {
    ...
    class C04122 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            TinyWebDB.this.androidUIHandler.post(new C02661());
        }
    ...
    private void postStoreValue(String tag, Object valueToStore) {
        AsyncCallbackPair<String> myCallback = new C04122();
        try {
    ...
    private void postGetValue(final String tag) {
        AsyncCallbackPair<JSONArray> myCallback = new AsyncCallbackPair<JSONArray>() {
            ...
            public void onSuccess(JSONArray result) {
                if (result == null) {
                    TinyWebDB.this.androidUIHandler.post(new C02691());
                    return;
                }
                try {
                    ...
                    TinyWebDB.this.androidUIHandler.post(new C02713());
                }
            }
