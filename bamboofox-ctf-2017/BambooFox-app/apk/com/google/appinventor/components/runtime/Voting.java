...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C04142 implements AsyncCallbackPair<JSONObject> {
        ...
        public void onSuccess(JSONObject result) {
            if (result == null) {
                Voting.this.androidUIHandler.post(new C02941());
                return;
            }
            try {
                ...
                if (Voting.this.isPolling.booleanValue()) {
                    ...
                    Voting.this.androidUIHandler.post(new C02952());
                    return;
                }
                Voting.this.androidUIHandler.post(new C02963());
            } catch (JSONException e) {
                Voting.this.androidUIHandler.post(new C02974());
            }
        }
    ...
    class C04154 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            Voting.this.androidUIHandler.post(new C03001());
        }
    ...
    public void RequestBallot() {
        AsynchUtil.runAsynchronously(new C02931());
    }

    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C04142());
    }
    ...
    public void SendBallot() {
        AsynchUtil.runAsynchronously(new C02993());
    }

    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C04154();
