...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f94break;
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda19recur(Object lists) {
            ...
            return Scheme.apply.apply2(this.f29f, srfi1.append$Ex$V(new Object[]{lists, LList.list1(lambda19recur(cdrs))}));
        }

        public Object lambda20recur(Object lis) {
            return srfi1.isNullList(lis) != Boolean.FALSE ? this.zero : this.f29f.apply2(lis, lambda20recur(lists.cdr.apply1(lis)));
        }
    }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda21recur(Object head, Object lis) {
            if (lists.isPair(lis)) {
                return this.f30f.apply2(head, lambda21recur(lists.car.apply1(lis), lists.cdr.apply1(lis)));
            }
            return head;
        }
    }
    ...
    public class frame12 extends ModuleBody {
        ...
        void lambda22(Object pair) {
            try {
                lists.setCar$Ex((Pair) pair, this.f31f.apply1(lists.car.apply1(pair)));
    ...
    public class frame14 extends ModuleBody {
        ...
        Object lambda25(Object cars, Object cdrs) {
            ...
            Boolean head = Scheme.apply.apply2(this.staticLink.f32f, cars);
    ...
    public class frame17 extends ModuleBody {
        ...
        boolean lambda28(Object y) {
            return ((Scheme.applyToArgs.apply3(this.maybe$Mn$Eq, this.f33x, y) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame30 extends ModuleBody {
        ...
        public Object lambda44lp(Object lists, Object n) {
            ...
            gnu_kawa_slib_srfi1_frame31.f35n = n;
    ...
    public class frame31 extends ModuleBody {
        ...
        Object lambda46(Object heads, Object tails) {
            ...
            if (!x) {
                ...
                return this.staticLink.lambda44lp(tails, AddOp.$Pl.apply2(this.f35n, srfi1.Lit1));
            }
        }
    ...
    public class frame37 extends ModuleBody {
        ...
        Object lambda54(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame38.f36x = x;
    ...
    public class frame38 extends ModuleBody {
        ...
        Object lambda55(Object lis) {
            return lists.member(this.f36x, lis, this.staticLink.$Eq);
        }
    ...
    public class frame39 extends ModuleBody {
        ...
        Object lambda56(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame40.f37x = x;
    ...
    public class frame41 extends ModuleBody {
        ...
        Object lambda58(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame42.f38x = x;
    ...
    public class frame42 extends ModuleBody {
        ...
        boolean lambda59(Object lis) {
            return ((lists.member(this.f38x, lis, this.staticLink.$Eq) != Boolean.FALSE ? 1 : 0) + 1) & 1;
        }
    ...
    public class frame43 extends ModuleBody {
        ...
        Object lambda60(Object x) {
            ...
            gnu_kawa_slib_srfi1_frame44.f39x = x;
    ...
    public class frame45 extends ModuleBody {
        ...
        Object lambda62(Object b, Object a) {
            ...
            gnu_kawa_slib_srfi1_frame46.f41b = b;
            gnu_kawa_slib_srfi1_frame46.f40a = a;
    ...
    public class frame46 extends ModuleBody {
        ...
        Object lambda63() {
            return srfi1.lsetDiff$PlIntersection$V(this.staticLink.$Eq, this.f40a, new Object[]{this.f41b});
        }
        ...
        Object lambda64(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$V(this.staticLink.$Eq, this.f41b, new Object[]{this.f40a});
            } else if (!lists.isNull(gnu_kawa_slib_srfi1_frame47.a$Mnint$Mnb)) {
                return srfi1.fold$V(gnu_kawa_slib_srfi1_frame47.lambda$Fn48, a$Mnb, this.f41b, new Object[0]);
            } else {
                return append.append$V(new Object[]{this.f41b, this.f40a});
            }
        }
    ...
    public class frame48 extends ModuleBody {
        ...
        Object lambda66(Object b, Object a) {
            ...
            gnu_kawa_slib_srfi1_frame49.f43b = b;
            gnu_kawa_slib_srfi1_frame49.f42a = a;
    ...
    public class frame49 extends ModuleBody {
        ...
        Object lambda67() {
            return srfi1.lsetDiff$PlIntersection$Ex$V(this.staticLink.$Eq, this.f42a, new Object[]{this.f43b});
        }
        ...
        Object lambda68(Object a$Mnb, Object aIntB) {
            ...
            if (lists.isNull(a$Mnb)) {
                return srfi1.lsetDifference$Ex$V(this.staticLink.$Eq, this.f43b, new Object[]{this.f42a});
            } else if (!lists.isNull(gnu_kawa_slib_srfi1_frame50.a$Mnint$Mnb)) {
                return srfi1.pairFold$V(gnu_kawa_slib_srfi1_frame50.lambda$Fn52, a$Mnb, this.f43b, new Object[0]);
            } else {
                return srfi1.append$Ex$V(new Object[]{this.f43b, this.f42a});
            }
        }
    ...
    public class frame59 extends ModuleBody {
        ...
        Object lambda80(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame60.f44a = a;
            gnu_kawa_slib_srfi1_frame60.f45d = d;
    ...
    public class frame60 extends ModuleBody {
        ...
        Object lambda82(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f44a, cars), lists.cons(this.f45d, cdrs));
        }
    ...
    public class frame65 extends ModuleBody {
        ...
        Object lambda89(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame66.f46a = a;
            gnu_kawa_slib_srfi1_frame66.f47d = d;
    ...
    public class frame66 extends ModuleBody {
        ...
        Object lambda91(Object cars, Object cdrs) {
            return misc.values(lists.cons(this.f46a, cars), lists.cons(this.f47d, cdrs));
        }
    ...
    public class frame69 extends ModuleBody {
        ...
        Object lambda96(Object a, Object d) {
            ...
            gnu_kawa_slib_srfi1_frame70.f48a = a;
            gnu_kawa_slib_srfi1_frame70.f49d = d;
    ...
    static {
        ...
        f94break = new ModuleMethod(moduleBody, 164, Lit80, 8194);
        break$Ex = new ModuleMethod(moduleBody, 165, Lit81, 8194);
        any = new ModuleMethod(moduleBody, YaVersion.YOUNG_ANDROID_VERSION, Lit82, -4094);
    ...
    public static Object pairFoldRight$V(Procedure f, Object zero, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame10.f29f = f;
    ...
    public static Object reduceRight(Procedure f, Object ridentity, Object lis) {
        ...
        gnu_kawa_slib_srfi1_frame11.f30f = f;
    ...
    public static Object map$Ex$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame12.f31f = f;
        Object lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
            Object lis12 = lis1;
            while (isNullList(lis12) == Boolean.FALSE) {
                ...
                try {
                    lists.setCar$Ex((Pair) lis12, Scheme.apply.apply3(gnu_kawa_slib_srfi1_frame12.f31f, lists.car.apply1(lis12), heads));
    ...
    public static Object filterMap$V(Procedure f, Object lis1, Object[] argsArray) {
        ...
        gnu_kawa_slib_srfi1_frame13.f32f = f;
        LList lists = LList.makeList(argsArray, 0);
        if (lists.isPair(lists)) {
        ...
        Object lis = lis1;
        while (isNullList(lis) == Boolean.FALSE) {
            Boolean head = gnu_kawa_slib_srfi1_frame13.f32f.apply1(lists.car.apply1(lis));
            Object tail = lists.cdr.apply1(lis);
            if (head != Boolean.FALSE) {
    ...
    public static Object delete(Object x, Object lis, Object maybe$Mn$Eq) {
        ...
        gnu_kawa_slib_srfi1_frame17.f33x = x;
    ...
    public static Object delete$Ex(Object x, Object lis, Object maybe$Mn$Eq) {
        ...
        gnu_kawa_slib_srfi1_frame18.f34x = x;
