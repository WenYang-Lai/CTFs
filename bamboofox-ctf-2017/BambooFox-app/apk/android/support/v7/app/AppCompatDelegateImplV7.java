...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C03892 implements OnApplyWindowInsetsListener {
        C03892() {
        }
    ...
    class C03903 implements OnFitSystemWindowsListener {
        C03903() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C03892());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C03903());
                }
