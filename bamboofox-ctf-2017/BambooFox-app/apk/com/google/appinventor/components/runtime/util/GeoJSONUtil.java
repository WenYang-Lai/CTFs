...
public final class GeoJSONUtil {
    ...
    static class C04161 implements PropertyApplication {
        C04161() {
        }
    ...
    static class C04172 implements PropertyApplication {
        C04172() {
        }
    ...
    static class C04183 implements PropertyApplication {
        C04183() {
        }
    ...
    static class C04194 implements PropertyApplication {
        C04194() {
        }
    ...
    static class C04205 implements PropertyApplication {
        C04205() {
        }
    ...
    static class C04216 implements PropertyApplication {
        C04216() {
        }
    ...
    static class C04227 implements PropertyApplication {
        C04227() {
        }
    ...
    static class C04238 implements PropertyApplication {
        C04238() {
        }
    ...
    static class C04249 implements PropertyApplication {
        C04249() {
        }
    ...
    static {
        ...
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new C04161());
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new C04172());
        SUPPORTED_PROPERTIES.put(PROPERTY_DESCRIPTION, new C04183());
        SUPPORTED_PROPERTIES.put(PROPERTY_DRAGGABLE, new C04194());
        SUPPORTED_PROPERTIES.put(PROPERTY_FILL, new C04205());
        SUPPORTED_PROPERTIES.put(PROPERTY_HEIGHT, new C04216());
        SUPPORTED_PROPERTIES.put(PROPERTY_IMAGE, new C04227());
        SUPPORTED_PROPERTIES.put(PROPERTY_INFOBOX, new C04238());
        SUPPORTED_PROPERTIES.put(PROPERTY_STROKE, new C04249());
