...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C04403 extends ViewPropertyAnimatorListenerAdapter {
        C04403() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C04392());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C04403());
        }
    }
