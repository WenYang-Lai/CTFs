...
@DesignerComponent(androidMinSdk = 7, category = ComponentCategory.LAYOUT, description = "Top-level component containing all other components in the program", showOnPalette = false, version = 21)
...
public class Form extends AppCompatActivity implements Component, ComponentContainer, HandlesEventDispatching, OnGlobalLayoutListener {
    ...
    private LinearLayout frameWithTitle;
    ...
    class C01985 implements Runnable {
        C01985() {
        }
    ...
    class C02018 implements OnMenuItemClickListener {
        C02018() {
        }
    ...
    class C02029 implements OnMenuItemClickListener {
        C02029() {
        }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (getSupportActionBar() == null || (this.titleBar == null && isRepl())) {
        ...
        if (this.titleBar != null) {
            if (this.titleBar.getParent() != null) {
                ((ViewGroup) this.titleBar.getParent()).removeAllViews();
            }
    ...
    public void Initialize() {
        this.androidUIHandler.post(new C01952());
    }
    ...
    private void recomputeLayout() {
        ...
        this.androidUIHandler.post(new C01985());
    }
    ...
    public void PrimaryColor(int color) {
        ...
        if (actionBar != null && newColor != this.primaryColor) {
    ...
    public void addExitButtonToMenu(Menu menu) {
        menu.add(0, 0, 1, "Stop this application").setOnMenuItemClickListener(new C02018()).setIcon(17301594);
    }

    public void addAboutInfoToMenu(Menu menu) {
        menu.add(0, 0, 2, "About this application").setOnMenuItemClickListener(new C02029()).setIcon(17301651);
    }
