...
public class FirebaseDB extends AndroidNonvisibleComponent implements Component {
    ...
    class C01811 implements ChildEventListener {
        C01811() {
        }
    ...
    class C01832 implements AuthStateListener {

        class C01821 implements AuthResultHandler {
            C01821() {
            }
        ...
        public void onAuthStateChanged(AuthData data) {
            ...
            if (data == null) {
                FirebaseDB.this.myFirebase.authWithCustomToken(FirebaseDB.this.firebaseToken, new C01821());
            }
        }
    }

    class C01896 implements ValueEventListener {
        C01896() {
        }
    ...
    public FirebaseDB(ComponentContainer container) {
        ...
        this.projectBucket = "";
        this.firebaseToken = "";
        this.childListener = new C01811();
        this.authListener = new C01832();
    }
    ...
    public void GetTagList() {
        this.myFirebase.child("").addListenerForSingleValueEvent(new C01896());
    }
        ...
        firebase.runTransaction(new Transaction.Handler() {
            ...
            public void onComplete(final FirebaseError firebaseError, boolean committed, DataSnapshot currentData) {
                if (firebaseError != null) {
                    ...
                    FirebaseDB.this.androidUIHandler.post(new C01912());
