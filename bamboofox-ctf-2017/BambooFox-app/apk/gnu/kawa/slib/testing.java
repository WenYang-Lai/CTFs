...
public class testing extends ModuleBody {
    ...
    public class frame1 extends ModuleBody {
        ...
        Object lambda9() {
            return ((Procedure) testing.test$Mnrunner$Mncurrent).apply1(this.f98r);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) {
            this.f99i = AddOp.$Pl.apply2(this.f99i, testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f99i, this.f100n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f99i, AddOp.$Pl.apply2(this.f100n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            gnu_kawa_slib_testing_frame.f101p = lists.assq(pname, alist);
            if (gnu_kawa_slib_testing_frame.f101p != Boolean.FALSE) {
                try {
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        gnu_kawa_slib_testing_frame1.f98r = testRunnerCreate();
        ...
        Object obj = gnu_kawa_slib_testing_frame1.f98r;
        try {
            return procedure.apply2(testRunnerOnFinal((test$Mnrunner) obj), gnu_kawa_slib_testing_frame1.f98r);
    ...
    public static Procedure $PcTestMatchNth(Object n, Object count) {
        ...
        gnu_kawa_slib_testing_frame2.f100n = n;
        gnu_kawa_slib_testing_frame2.count = count;
        gnu_kawa_slib_testing_frame2.f99i = Lit0;
