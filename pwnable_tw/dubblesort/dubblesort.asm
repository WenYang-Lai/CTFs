...
000001e0 <.dynsym>:
 ...
 260:	66 00 00             	data16 add BYTE PTR [eax],al
	...
...
00000360 <.dynstr>:
 ...
 368:	2e 36 00 5f 49       	cs add BYTE PTR ss:[edi+0x49],bl
 36d:	4f                   	dec    edi
 36e:	5f                   	pop    edi
 ...
 3a0:	66 00 73 69          	data16 add BYTE PTR [ebx+0x69],dh
 ...
 3c2:	65 65 70 00          	gs gs jo 3c6 <read@plt-0x26a>
 3c6:	5f                   	pop    edi
 3c7:	5f                   	pop    edi
 ...
 41b:	4d                   	dec    ebp
 41c:	5f                   	pop    edi
 41d:	64 65 72 65          	fs gs jb 486 <read@plt-0x1aa>
 ...
 454:	65 73 00             	gs jae 457 <read@plt-0x1d9>
 457:	5f                   	pop    edi
 458:	49                   	dec    ecx
 459:	54                   	push   esp
 45a:	4d                   	dec    ebp
...
00000bc8 <_IO_stdin_used@@Base-0x4>:
 bc8:	03 00                	add    eax,DWORD PTR [eax]
	...

00000bcc <_IO_stdin_used@@Base>:
 ...
 bd8:	50                   	push   eax
 bd9:	72 6f                	jb     c4a <_IO_stdin_used@@Base+0x7e>
 bdb:	63 65 73             	arpl   WORD PTR [ebp+0x73],sp
 bde:	73 69                	jae    c49 <_IO_stdin_used@@Base+0x7d>
 be0:	6e                   	outs   dx,BYTE PTR ds:[esi]
 be1:	67 2e 2e 2e 2e 2e 2e 	cs cs cs cs cs add BYTE PTR cs:[bx+0x68],dl
 be8:	00 57 68 
 beb:	61                   	popa   
 bec:	74 20                	je     c0e <_IO_stdin_used@@Base+0x42>
 bee:	79 6f                	jns    c5f <_IO_stdin_used@@Base+0x93>
 bf0:	75 72                	jne    c64 <_IO_stdin_used@@Base+0x98>
 ...
 bff:	74 65                	je     c66 <_IO_stdin_used@@Base+0x9a>
 c01:	72 20                	jb     c23 <_IO_stdin_used@@Base+0x57>
 c03:	74 68                	je     c6d <_IO_stdin_used@@Base+0xa1>
 ...
 c14:	52                   	push   edx
 c15:	65 73 75             	gs jae c8d <_IO_stdin_used@@Base+0xc1>
 c18:	6c                   	ins    BYTE PTR es:[edi],dx
 c19:	74 20                	je     c3b <_IO_stdin_used@@Base+0x6f>
 c1b:	3a 00                	cmp    al,BYTE PTR [eax]
 c1d:	25 75 20 00 00       	and    eax,0x2075
 c22:	00 00                	add    BYTE PTR [eax],al
 c24:	48                   	dec    eax
 c25:	65 6c                	gs ins BYTE PTR es:[edi],dx
 c27:	6c                   	ins    BYTE PTR es:[edi],dx
 c28:	6f                   	outs   dx,DWORD PTR ds:[esi]
 c29:	20 25 73 2c 48 6f    	and    BYTE PTR ds:0x6f482c73,ah
 c2f:	77 20                	ja     c51 <_IO_stdin_used@@Base+0x85>
 c31:	6d                   	ins    DWORD PTR es:[edi],dx
 c32:	61                   	popa   
 c33:	6e                   	outs   dx,BYTE PTR ds:[esi]
 c34:	79 20                	jns    c56 <_IO_stdin_used@@Base+0x8a>
 c36:	6e                   	outs   dx,BYTE PTR ds:[esi]
 c37:	75 6d                	jne    ca6 <_IO_stdin_used@@Base+0xda>
 c39:	62 65 72             	bound  esp,QWORD PTR [ebp+0x72]
 c3c:	73 20                	jae    c5e <_IO_stdin_used@@Base+0x92>
 c3e:	64 6f                	outs   dx,DWORD PTR fs:[esi]
 c40:	20 79 6f             	and    BYTE PTR [ecx+0x6f],bh
 c43:	75 20                	jne    c65 <_IO_stdin_used@@Base+0x99>
 c45:	77 68                	ja     caf <_IO_stdin_used@@Base+0xe3>
 c47:	61                   	popa   
 c48:	74 20                	je     c6a <_IO_stdin_used@@Base+0x9e>
 c4a:	74 6f                	je     cbb <_IO_stdin_used@@Base+0xef>
 c4c:	20 73 6f             	and    BYTE PTR [ebx+0x6f],dh
 c4f:	72 74                	jb     cc5 <_IO_stdin_used@@Base+0xf9>
...
00000ca0 <.eh_frame>:
 ...
 cad:	7c 08                	jl     cb7 <_IO_stdin_used@@Base+0xeb>
 ...
 ccf:	0f 0b                	ud2    
 cd1:	74 04                	je     cd7 <_IO_stdin_used@@Base+0x10b>
 cd3:	78 00                	js     cd5 <_IO_stdin_used@@Base+0x109>
 cd5:	3f                   	aas    
...
00001fa0 <.got>:
    ...
    1fbc:	76 06                	jbe    1fc4 <_IO_stdin_used@@Base+0x13f8>
