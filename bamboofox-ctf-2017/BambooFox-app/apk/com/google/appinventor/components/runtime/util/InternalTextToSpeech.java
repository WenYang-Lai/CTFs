...
public class InternalTextToSpeech implements ITextToSpeech {
    ...
    class C03271 implements OnInitListener {
        C03271() {
        }
    ...
    class C03292 implements OnUtteranceCompletedListener {
        ...
        public void onUtteranceCompleted(String utteranceId) {
            InternalTextToSpeech.this.activity.runOnUiThread(new C03281());
        }
    }
    ...
    private void initializeTts() {
        if (this.tts == null) {
            ...
            this.tts = new TextToSpeech(this.activity, new C03271());
        }
    }
    ...
    private void speak(final String message, final Locale loc, final int retries) {
        ...
        if (this.isTtsInitialized) {
            ...
            this.tts.setOnUtteranceCompletedListener(new C03292());
