...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04341();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04352();
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03923();

    class C03923 implements ViewPropertyAnimatorUpdateListener {
        C03923() {
        }
    ...
    class C04341 extends ViewPropertyAnimatorListenerAdapter {
        C04341() {
        }
    ...
    class C04352 extends ViewPropertyAnimatorListenerAdapter {
        C04352() {
        }
