...
class NativeOpenStreetMapController implements MapController, MapListener {
    ...
    class C03351 implements OnTapListener {
        C03351() {
        }
            ...
            switch (msg.what) {
                case 0:
                    if (!NativeOpenStreetMapController.this.ready && NativeOpenStreetMapController.this.form.canDispatchEvent(null, "MapReady")) {
                        ...
                        NativeOpenStreetMapController.this.form.runOnUiThread(new C03441());
                    }
    ...
    NativeOpenStreetMapController(Form form) {
        ...
        this.view.addOnTapListener(new C03351());
    ...
    public void addFeature(final MapMarker aiMarker) {
        createNativeMarker(aiMarker, new AsyncCallbackPair<Marker>() {
            ...
            class C03361 implements OnMarkerClickListener {
                C03361() {
                }
            ...
            class C03372 implements OnMarkerDragListener {
                C03372() {
                }
            ...
            public void onSuccess(Marker overlay) {
                overlay.setOnMarkerClickListener(new C03361());
                overlay.setOnMarkerDragListener(new C03372());
                if (aiMarker.Visible()) {
