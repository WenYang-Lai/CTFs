...
public class ReplForm extends Form {
    ...
    class C02552 implements OnMenuItemClickListener {
        C02552() {
        }
    ...
    class C02563 implements OnMenuItemClickListener {
        C02563() {
        }
    ...
    public void addSettingsButton(Menu menu) {
        menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new C02552()).setIcon(17301651);
    }

    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new C02563()).setIcon(17301642);
        }
    }
