...
public class pregexp extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda5loupOneOfChars(Object chars) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(gnu_kawa_slib_pregexp_frame1.chars), this.f17i, this.sk, gnu_kawa_slib_pregexp_frame1.lambda$Fn13);
        }
        ...
        Object lambda10() {
            return Scheme.applyToArgs.apply2(this.sk, AddOp.$Pl.apply2(this.f17i, pregexp.Lit8));
        }
        ...
        public Object lambda7loupOr(Object res) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(gnu_kawa_slib_pregexp_frame3.res), this.f17i, gnu_kawa_slib_pregexp_frame3.lambda$Fn15, gnu_kawa_slib_pregexp_frame3.lambda$Fn16);
        }
        ...
        Object lambda12(Object i1) {
            ...
            try {
                lists.setCdr$Ex((Pair) assv, lists.cons(this.f17i, i1));
        ...
        public Object lambda8loupP(Object k, Object i) {
            ...
            gnu_kawa_slib_pregexp_frame4.f21k = k;
            gnu_kawa_slib_pregexp_frame4.f20i = i;
            if (Scheme.numLss.apply2(gnu_kawa_slib_pregexp_frame4.f21k, this.f18p) != Boolean.FALSE) {
                return this.staticLink.lambda3sub(this.re, gnu_kawa_slib_pregexp_frame4.f20i, gnu_kawa_slib_pregexp_frame4.lambda$Fn17, this.fk);
            }
            gnu_kawa_slib_pregexp_frame4.f22q = this.f19q != Boolean.FALSE ? AddOp.$Mn.apply2(this.f19q, this.f18p) : this.f19q;
            return gnu_kawa_slib_pregexp_frame4.lambda24loupQ(pregexp.Lit73, gnu_kawa_slib_pregexp_frame4.f20i);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda24loupQ(Object k, Object i) {
            ...
            gnu_kawa_slib_pregexp_frame5.f24k = k;
            gnu_kawa_slib_pregexp_frame5.f23i = i;
            gnu_kawa_slib_pregexp_frame5.fk = gnu_kawa_slib_pregexp_frame5.fk;
            if (this.f22q == Boolean.FALSE ? this.f22q != Boolean.FALSE : Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame5.f24k, this.f22q) != Boolean.FALSE) {
                return gnu_kawa_slib_pregexp_frame5.lambda26fk();
            }
            if (this.staticLink.maximal$Qu) {
                return this.staticLink.staticLink.lambda3sub(this.staticLink.re, gnu_kawa_slib_pregexp_frame5.f23i, gnu_kawa_slib_pregexp_frame5.lambda$Fn18, gnu_kawa_slib_pregexp_frame5.fk);
            }
            Boolean x = gnu_kawa_slib_pregexp_frame5.lambda26fk();
            return x == Boolean.FALSE ? this.staticLink.staticLink.lambda3sub(this.staticLink.re, gnu_kawa_slib_pregexp_frame5.f23i, gnu_kawa_slib_pregexp_frame5.lambda$Fn19, gnu_kawa_slib_pregexp_frame5.fk) : x;
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda26fk() {
            return Scheme.applyToArgs.apply2(this.staticLink.staticLink.sk, this.f23i);
        }
        ...
        Object lambda28(Object i1) {
            return this.staticLink.lambda24loupQ(AddOp.$Pl.apply2(this.f24k, pregexp.Lit8), i1);
        }
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda3sub(Object re, Object i, Object sk, Object fk) {
            ...
            gnu_kawa_slib_pregexp_frame0.f17i = i;
            ...
            if (Scheme.isEqv.apply2(gnu_kawa_slib_pregexp_frame0.re$1, pregexp.Lit10) != Boolean.FALSE) {
                if (Scheme.numEqu.apply2(gnu_kawa_slib_pregexp_frame0.f17i, this.start) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i);
                }
                ...
                return Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
            } else {
                ...
                if (Scheme.isEqv.apply2(gnu_kawa_slib_pregexp_frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    if (pregexp.isPregexpAtWordBoundary(this.f26s, gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE) {
                        return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i);
                    }
                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                    ...
                    if (x ? Scheme.numLss.apply2(gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE : x) {
                        Procedure procedure = this.case$Mnsensitive$Qu != Boolean.FALSE ? characters.char$Eq$Qu : unicode.char$Mnci$Eq$Qu;
                        obj2 = this.f26s;
                        try {
                            charSequence = (CharSequence) obj2;
                            obj = gnu_kawa_slib_pregexp_frame0.f17i;
                            try {
                                return procedure.apply2(Char.make(strings.stringRef(charSequence, ((Number) obj).intValue())), gnu_kawa_slib_pregexp_frame0.re$1) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, AddOp.$Pl.apply2(gnu_kawa_slib_pregexp_frame0.f17i, pregexp.Lit8)) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                            } catch (ClassCastException e) {
                        ...
                        try {
                            ...
                            try {
                                if (pregexp.isPregexpCheckIfInCharClass(Char.make(strings.stringRef(charSequence, ((Number) obj).intValue())), gnu_kawa_slib_pregexp_frame0.re$1) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, AddOp.$Pl.apply2(gnu_kawa_slib_pregexp_frame0.f17i, pregexp.Lit8));
                                }
                                return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                    ...
                    if (x3 != null) {
                        ...
                        if (lists.isPair(gnu_kawa_slib_pregexp_frame0.re$1)) {
                            ...
                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit83) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                }
                                ...
                                return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, gnu_kawa_slib_pregexp_frame0.lambda$Fn2, gnu_kawa_slib_pregexp_frame0.lambda$Fn3);
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit5) != Boolean.FALSE) {
                                return gnu_kawa_slib_pregexp_frame0.lambda6loupSeq(lists.cdr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i);
                            } else {
                                ...
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj).intValue()), this.f26s, gnu_kawa_slib_pregexp_frame0.f17i, this.f25n, gnu_kawa_slib_pregexp_frame0.lambda$Fn4, gnu_kawa_slib_pregexp_frame0.fk);
                                    ...
                                    return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, gnu_kawa_slib_pregexp_frame0.lambda$Fn5, gnu_kawa_slib_pregexp_frame0.fk);
                                } else {
                                    if (Scheme.isEqv.apply2(tmp, pregexp.Lit103) != Boolean.FALSE) {
                                        return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, this.identity, pregexp.lambda$Fn6) != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                    } else {
                                        if (Scheme.isEqv.apply2(tmp, pregexp.Lit104) != Boolean.FALSE) {
                                            return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, this.identity, pregexp.lambda$Fn7) != Boolean.FALSE ? Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk) : Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i);
                                        } else {
                                            Object n$Mnactual;
                                            Object sn$Mnactual;
                                            Boolean found$Mnit$Qu;
                                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit105) != Boolean.FALSE) {
                                                n$Mnactual = this.f25n;
                                                sn$Mnactual = this.sn;
                                                this.f25n = gnu_kawa_slib_pregexp_frame0.f17i;
                                                this.sn = gnu_kawa_slib_pregexp_frame0.f17i;
                                                ...
                                                this.f25n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i) : Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                                                ...
                                                this.f25n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk) : Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit109) != Boolean.FALSE) {
                                                found$Mnit$Qu = lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, this.identity, pregexp.lambda$Fn10);
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    ...
                                                    return lambda3sub(lists.cadr.apply1(gnu_kawa_slib_pregexp_frame0.re$1), gnu_kawa_slib_pregexp_frame0.f17i, gnu_kawa_slib_pregexp_frame0.lambda$Fn11, gnu_kawa_slib_pregexp_frame0.lambda$Fn12);
                                                    ...
                                                    try {
                                                        ...
                                                        gnu_kawa_slib_pregexp_frame0.f18p = lists.caddr.apply1(gnu_kawa_slib_pregexp_frame0.re$1);
                                                        gnu_kawa_slib_pregexp_frame0.f19q = lists.cadddr.apply1(gnu_kawa_slib_pregexp_frame0.re$1);
                                                        if (gnu_kawa_slib_pregexp_frame0.maximal$Qu) {
                                                            obj2 = gnu_kawa_slib_pregexp_frame0.f19q;
                                                            try {
                                                                int i2;
                                                        ...
                                                        return gnu_kawa_slib_pregexp_frame0.lambda8loupP(pregexp.Lit73, gnu_kawa_slib_pregexp_frame0.f17i);
                        ...
                        } else if (Scheme.numGEq.apply2(gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE) {
                            return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                        } else {
                            return pregexp.pregexpError$V(new Object[]{pregexp.Lit101});
                        }
                ...
                } else if (pregexp.isPregexpAtWordBoundary(this.f26s, gnu_kawa_slib_pregexp_frame0.f17i, this.f25n) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply1(gnu_kawa_slib_pregexp_frame0.fk);
                } else {
                    return Scheme.applyToArgs.apply2(gnu_kawa_slib_pregexp_frame0.sk, gnu_kawa_slib_pregexp_frame0.f17i);
                }
