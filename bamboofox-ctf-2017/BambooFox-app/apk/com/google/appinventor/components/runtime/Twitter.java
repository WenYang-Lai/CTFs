...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C02856 implements Runnable {
        ...
        class C02841 implements Runnable {
            ...
            public void run() {
                ...
                for (Status status : C02856.this.replies) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C02841());
            }
        }
    }

    class C02877 implements Runnable {
        ...
        class C02861 implements Runnable {
            ...
            public void run() {
                ...
                for (User user : C02877.this.friends) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C02861());
            }
        }
    }
    ...
    class C02898 implements Runnable {
        ...
        class C02881 implements Runnable {
            ...
            public void run() {
                ...
                for (DirectMessage message : C02898.this.messages) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C02881());
            }
        }
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C02731());
                    return;
                }
                try {
                    ...
                    Twitter.this.handler.post(new C02742());
                }
            }
        });
    }
    ...
    public void CheckAuthorized() {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C02781());
                }
            }
        });
    }
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Twitter.this.handler.post(new C02801());
                        } catch (TwitterException e) {
    ...
    public void RequestMentions() {
        ...
        AsynchUtil.runAsynchronously(new C02856());
    }
    ...
    public void RequestFollowers() {
        ...
        AsynchUtil.runAsynchronously(new C02877());
    }
    ...
    public void RequestDirectMessages() {
        ...
        AsynchUtil.runAsynchronously(new C02898());
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C02751());
                }
            }
        });
    }
