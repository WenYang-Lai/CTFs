...
public class syntax extends ModuleBody {
    ...
    public static final Macro f107import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f108synchronized;
    ...
    static {
        ...
        f108synchronized = Macro.make(Lit25, new ModuleMethod(moduleBody, 3, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), $instance);
